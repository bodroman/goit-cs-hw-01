...
class Parser:
    ...
    def factor(self):
        """Парсер для 'factor' правил граматики. Це можуть бути цілі числа або дужки."""
    ...
    def term(self):
        """Парсер для 'term' правил граматики, включаючи множення і ділення."""
        node = self.factor()
    ...
    def expr(self):
        """Парсер для арифметичних виразів, включаючи додавання і віднімання."""
        node = self.term()
